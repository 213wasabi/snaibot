...
For a correct use of the markdown, check [this post](https://telegra.ph/markdown%E5%B8%B8%E7%94%A8%E8%AF%AD%E6%B3%95%E5%A4%A7%E5%85%A8-06-30) in the channel
...
local function do_keyboard_private(self)
	...
	keyboard.inline_keyboard = {
		{
			{text = i18n("📢 Bot channel"), url = 'https://t.me/'..config.channel:gsub('@', '')},
